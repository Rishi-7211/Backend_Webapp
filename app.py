...
connection_string = "Driver={ODBC Driver 18 for SQL Server};Server=tcp:sqldatabse.database.windows.net,1433;Database=Sqldatabse;Uid=sqladmin;Pwd=Devops@123456;Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;"
